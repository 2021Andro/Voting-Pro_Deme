...
public class Political_Category implements Serializable {
    ...
    public Political_Category() {
    }

    public Political_Category(String id, String profileImage, String name, String status, String subject, String like_Voting, String neutral_Voting, String dislike_Voting, String all_Voting) {
        Id = id;
    ...
    public Political_Category(String profileImage, String name, String status, String subject, String like_Voting, String neutral_Voting, String dislike_Voting, String all_Voting) {
        ProfileImage = profileImage;
        Name = name;
        Status = status;
        Subject = subject;
    ...
    public Political_Category(String name, String status, String subject, String like_Voting, String neutral_Voting, String dislike_Voting, String all_Voting) {
        Name = name;
        Status = status;
        Subject = subject;
        Like_Voting = like_Voting;
